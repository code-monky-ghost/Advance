 ...
 * @author user
 */
public class NotePad2 extends javax.swing.JFrame implements Runnable {
	/**
	...
	public void fileCopy() throws IOException {
		...
		//tfDir 에 입력한 값 얻어오기
		String dirName = tfDir.getText();
		
		//입력값 널, 공백 잡기
		if(dirName== null|| dirName.trim().isEmpty()) {
			JOptionPane.showMessageDialog(this, "파일경로를 옳바르게 입력하세요");
			tfDir.requestFocus();
			return;
		}
	...
	private void initComponents() {
		...
		btHelp.setFont(new java.awt.Font("굴림", 1, 12)); // NOI18N
		btHelp.setText("Help");
